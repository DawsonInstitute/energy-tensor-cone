...
# With no vertex.json in the temp dir the function writes the no-data placeholder.
generate_lean_candidates(tmp, out, top_k=5)
text = out.read_text()
assert "Auto-generated by python/analyze_results.py" in text, \
    f"Expected header comment, got:\n{text}"
print("generate_lean_candidates: OK")
PY
