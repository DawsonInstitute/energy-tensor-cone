...
\data{All code, formal proofs, computational data, and supplementary materials for this work are available in an anonymized repository during peer review. Full details including permanent archival and reproducibility documentation will be provided upon acceptance.
\begin{itemize}
\item \textbf{Anonymized repository}: \url{https://anonymous.4open.science/r/aqei-convex-cone-5789/} — complete source code, Lean proofs, Mathematica search scripts, and test suites
