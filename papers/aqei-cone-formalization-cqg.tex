...
\author{Ryan Sherrington$^{1}$}

\affil{$^1$Dawson Institute for Advanced Physics, United States of America}
...
\ack{The author thanks the Lean community for Mathlib4 development and the open-source computational mathematics ecosystem.}

\data{All code, formal proofs, computational data, and supplementary materials for this work are publicly available:
\begin{itemize}
...
\item \textbf{Zenodo archive}: DOI 10.5281/zenodo.18522457 — persistent versioned snapshot with manuscript, supplements, and reproducibility documentation
...
The complete pipeline is reproducible via \texttt{./run\_tests.sh}. See repository documentation for detailed instructions.}
