...
Our computational findings are consistent with the general expectation that AQEI constraints define a convex cone with non-trivial boundary structure. However, we have not yet performed detailed comparisons with analytic bounds derived for specific quantum field theories (e.g., free scalar field AQEI bounds from Fewster's work).
