...
We work with a finite Gaussian basis ($N=100$ modes, scaled from initial $N=6$ for enhanced geometric coverage). While the vertex property is rigorously verified in this discretization, the connection to the full infinite-dimensional QFT remains to be established. The finite-dimensional extreme rays identified here may or may not correspond to extreme rays of the full theory.
