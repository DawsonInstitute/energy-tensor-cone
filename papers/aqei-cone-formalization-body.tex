...
\item \textbf{Data processing}: \texttt{python/orchestrator.py}, \texttt{python/analyze\_results.py} (JSON parsing, Lean code generation, and pipeline validation), \texttt{python/sanity\_checks.py} (pre-flight file-existence and import checks), \texttt{python/check\_rational\_values.py} (SymPy independent verification of rational certificate)
