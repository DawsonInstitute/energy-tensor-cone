...
\item Export the certified LP vertex and its active constraints to \texttt{mathematica/results/vertex.json}; the Python script \texttt{analyze\_results.py} then validates constraint saturation and writes a machine-readable audit record (\texttt{pipeline\_validation.json}).
